            ...
            <!-- box 1 -->
             <div style="height: 450px;" class="product-box">
              ...
              <div style="height: 450px;" class="product-box">
                ...
                <img style="height: 260px;" src="images/gift cards.png" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
             ...
             <div style="height: 450px;" class="product-box">
              ...
              <div style="height: 450px;" class="product-box">
                ...
                <img style="height: 250px;" src="images/gifts/1__11_-removebg-preview.png" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
             ...
             <div style="height: 450px;" class="product-box">
                ...
                <img style="height: 250px;" src="images/gifts/1__5_-removebg-preview.png" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
