            ...
            <!-- box 1 -->
             <div style="background-color: #fff;" class="product-box">
              <div class="new">
                ...
                <img src="images/new arivals/1 (10).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Wrist smart watch  Bands braclet</h2>
              ...
              <div class="product-box">
                ...
                <img src="images/new arivals/1 (11).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Ultra-thin Fingertips Sleeves</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (12).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Tai-Chi Dumbbell Ear Studs</h2>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (13).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Women's Multi-layer Pearl </h2>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (14).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">5.0 Bluetooth Earphones LED Display Touch</h2>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (15).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Men's Retro Volcanic Stone Yoga Bracelet</h2>
                <span class="price">₦5.000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (16).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Car Tire Air Inflator Hose Inflatable Pump</h2>
                <span class="price">₦8,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (17).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">1 Pcs Rolling Knee Protection Pad With Wheels</h2>
                <span class="price">₦10,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (19).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Zyre 2 Slice Sandwich Maker (EL-216) - Black</h2>
                <span class="price">₦15,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (20).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Zyre 1.6W Steam Iron (T-607A) - Blue</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (21).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Bluetooth Powerful Home Theater Black 2024 New</h2>
                <span class="price">₦8,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (22).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Ox 18 Plus Wall Fan - 18'' Inch</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img  src="images/new arivals/1 (23).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Hisense 2HP FLOOR STANDING INVERTER AIR CONDITIONER</h2>
                <span class="price">₦9,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img  src="images/new arivals/1 (24).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Royal 1.5HP SPLIT INVERTER AC UNIT</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img  src="images/new arivals/1 (25).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Hisense 93 DR 93-Litre Single Door Refrigerator</h2>
                <span class="price">₦8,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (8).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">F9 Portable LED Power Display Wireless Bluetooth 5.0-Black</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img style="height: 250px;" src="images/new arivals/1 (9).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 400;font-size: small;" class="product-title">4 In 1 D9 Eats Chicken Toist,For IPhone, Galaxy, Sony, HTC, LG, Huawei, Xiaomi, Tablet Pad Button And Other Smartphones</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="images/new arivals/1 (28).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">220V/12V 600W Bluetooth HiFi Audio Stereo Power Amplifier</h2>
                <span class="price">₦8,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img  src="images/new arivals/1 (10).jpg" alt="" class="product-img">
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Wrist Smart Watch Bands Bracelet Strap</h2>
                <span class="price">₦8,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
        ...
        <div class="row">
          ...
          <form action="subscribe.php" method="POST">
            <h6>
              ...
              <h5 style="font-family: 'Times New Roman', Times, serif;font-size: 15px;">NEW TO COSBAY?</h5>
