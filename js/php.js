...
function submitCart() {
    ...
    cartItems.forEach((item) => {
        ...
        // Ensure all essential details are present and valid
    ...
    console.log('Collected Cart Data:', cartData); // Debugging: check the cart data
    ...
    .catch(error => {
        console.error('Error:', error);
        alert(`An error occurred while saving your cart. ${error}`);
    });
}
