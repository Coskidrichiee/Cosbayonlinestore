...
<input type="hidden" id="loginStatus" value="<?php echo isset($_SESSION['loggedin']) && $_SESSION['loggedin'] ? 'true' : 'false'; ?>">
            ...
            <div class="carousel-item active">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                      <img style="width: 300px;height: 300px;" src="images/Screenshot 2024-08-04 1858382.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="carousel-item ">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      <h1 style="font-family: poopin;font-weight: 400;text-transform: uppercase;">Ode De Vanile
                    </h1>
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                      <img style="width: 400px;height: 400px"; src="images/perfume-removebg-preview.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
         ...
         <div class="shop-content">
            ...
            <div class="product-box">
              <div class="new">
                ...
                <a href="product1.html"><img src="images/dell-removebg-preview.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 class="product-title">Laptops & Phones</h2>
              ...
              <div class="product-box">
                ...
                <a href="product2.html"><img src="images/hoddy_2-removebg-preview.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 class="product-title">Clothes</h2>
             ...
             <div class="product-box">
              <div class="new">
                ...
                <a href="product3.html"><img src="images/sneaker white.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
              ...
              <div class="product-box">
                ...
                <a href="product4.html"><img src="images/gen 1.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 class="product-title">Generators</h2>
              ...
              <div class="product-box">
                ...
                <a href="product5.html"><img src="images/home_6-removebg-preview.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 class="product-title">Home Appliances</h2>
              ...
              <div class="product-box">
                ...
                <a href="product6.html"><img src="images/p5.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 class="product-title">Baby Supplies</h2>
              ...
              <div class="product-box">
                ...
                <a href="product7.html"><img src="images/p6.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 class="product-title">Flowers & Giftcards</h2>
             ...
             <div class="product-box">
              <div class="new">
                ...
                <a href="product8.html"><img src="images/perfume-removebg-preview.png" alt="" class="product-img"></a>
                <i class="far fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
  ...
  <!-- end saving section -->
   <!-- sponsorship -->
  <div style="background-color: rgba(0, 0, 0, 0.295);" id="sponsor">
            ...
            <div class="box">
              <div class="client_info">
                <div class="client_name">
                  ...
                  <h6>
                    Rachaelodogwu345@yahoomail.com
                  </h6>
                </div>
                <i class="fa fa-quote-left" aria-hidden="true"></i>
              </div>
              <p>
                I had an amazing shopping experience at "COSBAY"! The staff were incredibly friendly and helpful, and the selection of products was vast and varied. I was able to find exactly what I was looking for, and the prices were very reasonable. The store was well-organized and easy to navigate, making it a pleasure to shop there. I was also impressed with the fast and efficient checkout process. Overall, I would highly recommend "COSBAY" to anyone looking for a great shopping experience. 5 stars!"
              </p>
            </div>
          </div>
          <div class="carousel-item">
            <div class="box">
              <div class="client_info">
                <div class="client_name">
                  ...
                  <h6>
                    Adekunlesamuel225@outlook.com
                  </h6>
                </div>
                <i class="fa fa-quote-left" aria-hidden="true"></i>
              </div>
              <p>
                "I recently shopped at "COSBAY" and was blown away by the exceptional customer service! The team went above and beyond to help me find the perfect gift, and even offered personalized recommendations. The store's atmosphere was welcoming and modern, making it a joy to browse. The quality of the products was top-notch, and the prices were unbeatable. I've never had a better shopping experience anywhere else. Thank you, "COSBAY", for exceeding my expectations!"
              </p>
            </div>
          </div>
          <div class="carousel-item">
            <div class="box">
              <div class="client_info">
                <div class="client_name">
                  ...
                  <h6>
                    Bradjohnson234@gmail.com
                  </h6>
                </div>
                <i class="fa fa-quote-left" aria-hidden="true"></i>
              </div>
              <p>
                "I was impressed by the vast selection of products at "COSBAY". The staff were knowledgeable and helped me find exactly what I needed. The prices were competitive, and the checkout process was seamless. I'll definitely be back!"
              </p>
            </div>
          </div>
        </div>
